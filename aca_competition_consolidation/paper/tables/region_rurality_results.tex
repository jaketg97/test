...
% Date and time: Sat, Feb 27, 2021 - 11:59:31 AM
\begingroup 
\scriptsize 
...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 Hospital HHI (logged) & 0.042$^{***}$ & 0.035$^{**}$ \\ 
  & (0.011) & (0.015) \\ 
  & & \\ 
...
Residual Std. Error & 0.182 (df = 3662) & 0.182 (df = 3661) \\ 
F Statistic & 37.187$^{***}$ (df = 465; 3662) & 37.014$^{***}$ (df = 466; 3661) \\ 
\hline 
\hline \\[-1.8ex] 
