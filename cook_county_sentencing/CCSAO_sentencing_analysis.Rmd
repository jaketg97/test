...
boyle_reg_3_boot <- boot(data = boot_data, statistic = bs, R = 1000, formula=severe_sentenceTRUE ~ boyle_dummyTRUE + .)

summary(boyle_reg_3_boot, index = 2)
plot(boyle_reg_3_boot, index = 2)
boot.ci(boyle_reg_3_boot, index = 2)
```