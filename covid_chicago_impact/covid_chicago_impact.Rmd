...
covid_deaths_map_data <- sp::merge(chicago_tracts, chicago_covid_cases, "GEOID", duplicateGeoms = TRUE)

covid_deaths_map_data <- subset(covid_deaths_map_data, covid_deaths_map_data$Deaths...Cumulative != "NA")

popup <- paste0("TRACT: ", covid_deaths_map_data$GEOID, "<br>", "Covid-19 Deaths: ", covid_deaths_map_data$Deaths...Cumulative)
pal <- colorNumeric(
  palette = "YlGnBu",
