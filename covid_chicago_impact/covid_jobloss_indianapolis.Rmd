...
popup <- paste0("GEOID: ", mobility_merged$GEOID, "<br>", "Percent of Low Income Jobs Lost: ", mobility_merged$low_income_worker_job_loss_rate)
pal <- colorNumeric(
  palette = "YlGnBu",
...
mobility_map<-leaflet() %>%
  ...
  addPolygons(data = mobility_merged, 
              ...
              popup = popup) %>%
  addLegend(pal=pal,
            values = mobility_merged$low_income_worker_job_loss_rate, 
